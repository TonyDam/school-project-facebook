@extends('layouts.app')
@section('title')
School Project Facebook - Compte
@endsection
@section('style')
<script>
    function unmask() {
...
<style>
    .theMask { border: none; position: absolute; right: 1.5px; top: 50%; transform: translate(-50%, -50%); filter: grayscale(80%); }

    #traitDiag { right: 25px; top: 45%; border: 1px solid red; width: 22px; position: absolute; border-radius: 22%; transform: rotate(-45deg); display: block; }
